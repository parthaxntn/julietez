...
export declare type BakingRightsQueryArguments = BakingRightsQueryArgumentsProto12 | BakingRightsQueryArgumentsBase;
export interface BakingRightsQueryArgumentsProto12 extends Omit<BakingRightsQueryArgumentsBase, 'max_priority'> {
    max_round?: string;
}
...
export declare type InternalOperationResultKindEnum = OpKind.REVEAL | OpKind.TRANSACTION | OpKind.ORIGINATION | OpKind.DELEGATION | OpKind.REGISTER_GLOBAL_CONSTANT | OpKind.SET_DEPOSITS_LIMIT;
...
export declare type InternalOperationResultEnum = OperationResultReveal | OperationResultTransaction | OperationResultDelegation | OperationResultOrigination | OperationResultRegisterGlobalConstant | OperationResultSetDepositsLimit;
